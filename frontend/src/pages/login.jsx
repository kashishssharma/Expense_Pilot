      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-brand-700 via-surface-900 to-surface-950 p-12 flex-col justify-between">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            {[
              { icon: BarChart3, title: 'Financial Insights', desc: 'Rule-based spending pattern analysis' },
              { icon: Shield, title: 'Budget Guard', desc: 'Automated warnings on spending overruns' },
              { icon: Zap, title: 'Data Export', desc: 'One-click CSV exports' },
